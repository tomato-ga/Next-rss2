...
const Fav = ({ postId, articleData }) => {
    ...
    return (
        <div className="flex gap-2 items-center" onClick={incrementFavCount}>
            <button className={`py-1.5 px-3 ${isFavorited ? 'opacity-50 cursor-not-allowed' : 'hover:text-blue-600 hover:scale-105 hover:shadow'} text-center border  rounded-md font-bold border-blue-400 text-blue-700 h-8 text-sm flex items-center gap-1 lg:gap-2`}>
                お気に入り登録
